...
tinyMCE.init({
    ...
    theme_advanced_buttons1: "bold,italic,|,pastetext,pasteword,|,link,unlink,|,image,|,media,charmap,|,code,|,table,|,bullist,numlist,blockquote,|,undo,redo,|,removeformat,formatselect",
